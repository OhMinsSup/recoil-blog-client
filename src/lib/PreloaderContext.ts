...
type PreloadContextType = { done: boolean; promises: any[] } | null;
const PreloadContext = createContext<PreloadContextType>(null);
export default PreloadContext;

// resolve는 함수 타입입니다.
export const Preloader = ({ resolve }: { resolve: Promise<any> | any }) => {
...
export const usePreloader = (resolve: Promise<any> | any) => {
  const preloadContext = useContext(PreloadContext);
